...
from model.roi_module import RoIPPooling2D
...
class FasterRCNN(nn.Module):
    ...
    def predict(self, imgs, sizes=None, visualize=False):
        ...
        for img, size in zip(prepared_imgs, sizes):
            ...
            cls_bbox = at.tonumpy(cls_bbox).view(-1, self.n_class, 4)
...
class RoIHead(nn.Module):
    def __init__(self, n_class, roi_size, spatial_scale, fc7):
        ...
        self.roi = RoIPPooling2D(self.roi_size, self.roi_size, self.spatial_scale)
        self.fc7 = fc7
    ...
    def forward(self, x, rois, roi_indices):
        ...
        pool = pool.view(pool.size(0), -1)  # N个RoI下采样的结果reshape为一维向量
